...
public class Nazrul {
    ...
    private final String role     = "Fintech Software Developer";
    private final String location = "Kuching, Sarawak, Malaysia";
    private final String degree   = "MSc in NLP @ UNIMAS";

    private final List<String> shipping = List.of(
        "Payment rails & compliance services (Java / Spring Boot)",
        "TempahKu — multi-tenant booking SaaS",
        "RentBro  — rental property ledger"
    );

    public String currentFocus() {
        return "Making distributed money movement boring and correct.";
    }
}
```

I build backend services for a fintech payment and compliance platform — **Java/Spring Boot** on the server, **Oracle SQL** underneath, **Flutter** and **React** at the edges.

Before that I spent my MSc on **US2UCD**: an NLP pipeline (Stanza, CoreNLP) that generates UML use case diagrams straight from natural-language user stories. Three publications, sixteen citations, and a permanent habit of over-formalizing things that did not need formalizing.

The rest of the time I build small SaaS products end to end, mostly to find out whether I can.
...
> **US2UCD** — *Automated generation of UML use case diagrams from natural-language user stories.*
>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/mohammad-nazrul/mohammad-nazrul/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/mohammad-nazrul/mohammad-nazrul/output/github-snake.svg" />
  <img src="https://raw.githubusercontent.com/mohammad-nazrul/mohammad-nazrul/output/github-snake.svg" alt="Contribution snake" />
</picture>
...
- **Rebuilding** this profile — properly, this time.
- **Studying** Microsoft's AI-For-Beginners curriculum, tying it back to the NLP work.
- **Shipping** TempahKu toward its first paying tenant.
- **Off the clock** — too much Dota 2, on a PC built specifically to justify it.
...
<i>Kuching, Sarawak &nbsp;·&nbsp; UTC+8 &nbsp;·&nbsp; usually shipping something at 1am</i>
